...
#kontur
# _, contours, hierarch = cv2.findContours(coin_thresh.copy(), cv2.RETR_CCOMP ,cv2.CHAIN_APPROX_SIMPLE)
contours, hierarch = cv2.findContours(coin_thresh.copy(), cv2.RETR_CCOMP ,cv2.CHAIN_APPROX_SIMPLE)
