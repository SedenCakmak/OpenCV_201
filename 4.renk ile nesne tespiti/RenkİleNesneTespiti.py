...
while True:
    ...
    if success:
        ...
        if len(contours)>0:
            ...
            cv2.drawContours(imgOriginal,[box],0,(0,255,255),3)
           
            #merkeze bir tane nokra çiz
            cv2.circle(imgOriginal, center,5,(255,0,255),-1)
            
            #bilgileri ekrana yazdır
            cv2.putText(imgOriginal, s,(25,50), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1,(0,0,0),3)
